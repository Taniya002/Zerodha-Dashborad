...
const WatchListItem=({stock})=>{
  const[showwachlisytActions, setshowwachlisytActions]=useState(false)

  const handleMouseEnter=(e)=>{
    setshowwachlisytActions(true)
  }
  const handleMouseExit=(e)=>{
    setshowwachlisytActions(false)
  }
  ...
  return(
    <li onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseExit}>
      ...
      {showwachlisytActions && <WatchListAction uid={stock.name
